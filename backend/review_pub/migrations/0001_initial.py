    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_submitted', models.DateTimeField(auto_now_add=True, verbose_name='submission date')),
                ('date_approved', models.DateTimeField(blank=True, editable=False, null=True, verbose_name='approved date')),
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='owned_papers', to=settings.AUTH_USER_MODEL, verbose_name='uploaded by')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('result', models.CharField(blank=True, choices=[('APPROVED', 'Approved'), ('REJECTED', 'Rejected')], max_length=20, null=True, verbose_name='review result')),
                ('feedback', models.TextField(blank=True, null=True, verbose_name="Reviewer's feedback")),
                ('date_requested', models.DateTimeField(auto_now_add=True, verbose_name='requested date')),
                ('date_completed', models.DateTimeField(blank=True, editable=False, null=True, verbose_name='requested date')),
